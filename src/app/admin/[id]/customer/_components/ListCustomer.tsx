    ...
    <div className="max-w-full mx-auto p-6 bg-white min-h-screen">
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-600">Aqui puedes ver los clientes de la sucursal.</p>
        </div>
        ...
        <CardContent className="p-0">
          <div className="flex justify-between items-center p-6 border-b">
            <h3 className="font-medium text-gray-900">
              Hay <span className="text-gray-500 font-normal">58 clientes</span>
            </h3>
          </div>
            ...
            <TableBody>
              {filteredInquiries.map((inquiry) => (
                <TableRow key={inquiry.id}>
                  ...
                  <TableCell>
                    <div>
                      <div className="font-medium text-gray-900">{inquiry.executedBy.name}</div>
                      <div className="text-sm text-gray-500">{inquiry.executedBy.email}</div>
                    </div>
                  </TableCell>
